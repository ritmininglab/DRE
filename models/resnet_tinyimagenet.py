...
# ResNet }}}
def tResNet18(pretrained=False):
    return ResNet(get_builder(), BasicBlock, [2, 2, 2, 2], 50)

def tResNet34(pretrained = False):
    return ResNet(get_builder(), BasicBlock, [3, 4, 6, 3], 50)

def tResNet50(pretrained=False):
    return ResNet(get_builder(), Bottleneck, [3, 4, 6, 3], 50)


def tResNet101(pretrained=False):
    return ResNet(get_builder(), Bottleneck, [3, 4, 23, 3], 50)


def tWideResNet50_2(pretrained=False):
    return ResNet(
        get_builder(), Bottleneck, [3, 4, 6, 3], num_classes=50, base_width=64 * 2
    )


def tWideResNet101_2(pretrained=False):
    return ResNet(
        get_builder(), Bottleneck, [3, 4, 23, 3], num_classes=50, base_width=64 * 2
    )
